...
- `abandon_tier1` — saw $31.99 Foundation, didn't buy
- `abandon_tier2` — saw $97 Rise, didn't buy
- `abandon_tier3` — saw $27/mo or $197/yr Stay Ready, didn't buy
- `abandon_addon_<slug>` — saw a specific add-on

Each email below has tier-specific swap blocks marked `[TIER SWAP]`. Default copy is for Tier 2 ($97 Rise) since it's the most common abandon point. Swap the offer line and CTA based on the tag.
...
If $97 isn't the number that works this month, start at **[Tier 1: Foundation — $31.99](https://builttohoop.gumroad.com/l/ecyzaa).** Same system, the first block of it. Smaller commitment, and you can upgrade anytime — I'll credit what you paid.
...
If a subscriber abandons Tier 1 ($31.99), use the same structure but change Email 2's "It's $97" objection to:
...
If they abandon Tier 3 (membership), Email 2's "It's $97" block becomes:
