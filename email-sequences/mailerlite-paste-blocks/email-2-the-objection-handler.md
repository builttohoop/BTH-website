...
## MailerLite settings
- **Send delay from previous step:** 24 hours (after Email 1)
- **Subject (A):** `the 3 reasons people don't pull the trigger`
- **Subject (B):** `quick — is it the price, the time, or the "later"?`
