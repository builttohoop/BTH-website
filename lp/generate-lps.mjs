...
const offerCardB = () => `<div class="form-card member" id="join">
    ...
    <p class="form-trust">Secure Stripe checkout. Cancel anytime.<br>Not sure yet? <a href="#free-start" style="color:var(--gold-text);">Start with the free 5-Day Reset &rarr;</a></p>
  </div>`;
