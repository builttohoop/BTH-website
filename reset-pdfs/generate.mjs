...
<div class="close-band">
  ...
  <p class="close-body">Five days worked the stiffness loose. <b>BTH Stay Ready</b> is the system that keeps you ahead of it — the full month-by-month training system plus all 5 add-on tracks, built for hoopers who still play for real. A new block every month. Cancel anytime.</p>
